    ...
    <div className="container flex min-h-[calc(100vh-8rem)] items-center justify-center py-14">
      <div className="w-full max-w-sm rounded-2xl border border-border bg-surface p-8 shadow-soft">
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <h1 className="mt-4 font-display text-2xl font-semibold">Join the community</h1>
          <p className="mt-1 text-sm text-muted-foreground">Create an account to save favourites and submit listings.</p>
        </div>
