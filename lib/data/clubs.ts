...
export const clubs: Club[] = [
  {
    id: "cl1",
    slug: "berlin-gorkha-cricket-club",
    name: "Berlin Gorkha Cricket Club",
    citySlug: "berlin",
    ...
    description:
      "Berlin's oldest Nepali cricket club, founded in 2014. We play tape-ball on Sundays and compete in the Berlin Cricket League every summer.",
    social: {
      instagram: "https://instagram.com/berlingorkhacc",
      facebook: "https://facebook.com/berlingorkhacc",
      whatsapp: "https://wa.me/491234567890",
    },
    captainName: "Bijay Thapa",
    phone: "+49 30 1234 5678",
    email: "hello@berlingorkhacc.de",
    practiceLocation: "Tempelhofer Feld, Berlin",
    practiceTime: "Sundays, 10:00 – 13:00",
  ...
  {
    id: "cl6",
    slug: "cologne-rhine-cricket-club",
    name: "Cologne Rhine Cricket Club",
    citySlug: "cologne",
    categorySlug: "cricket",
    logo: "https://picsum.photos/seed/rhine-cc-logo/200/200",
    coverImage: "https://picsum.photos/seed/rhine-cc-cover/1200/600",
    description: "Friendly tape-ball cricket every other Sunday along the Rhine.",
    social: { instagram: "https://instagram.com/cologneRhinecc" },
    captainName: "Deepak Shrestha",
